...
contract Token is BEP20 {
    ...
    // Masterchef address to whitelist in transfer fees to help stakers to compound
     ...
     */
    constructor() public BEP20("TEST Werewolf.farm Bloodmoon Token", "BLOODMOON") {
    ...
    function initMasterchef(address _masterchef) public onlyOperator {
        require(masterchef == address(0), "TOKEN::initMasterchef: Masterchef address can only be initialized 1 time.");
